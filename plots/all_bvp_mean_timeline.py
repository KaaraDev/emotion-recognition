# -*- coding: utf-8 -*-
"""
CASE Dataset — BVP: gemittelte Kurven pro Video (über alle Subjekte)
...
N_POINTS = 600
GAP_POINTS = 20
Z_SCORE_PER_SEGMENT = False
SAVE_FIG = True
FIG_OUT = Path("bvp_mean_serial_by_video.png")
DPI = 200
...
ALPHA_FILL = 0.25  # Transparenz für SD-Fläche
LW_MEAN = 2.0  # Liniendicke für Mittelwert
...
for sid in SUBJECTS:
    ...
    if not {"daqtime", "bvp", "video"}.issubset(df.columns):
