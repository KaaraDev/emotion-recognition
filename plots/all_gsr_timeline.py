# -*- coding: utf-8 -*-
"""
CASE Dataset — EDA/GSR: nur Individualkurven, Videos hintereinander (seriell)
...
SAVE_FIG = True
FIG_OUT = Path("eda_individual_serial_by_video.png")
DPI = 200
...
TITLE = "EDA/GSR — individual curves only; videos in series (0–1 per segment)"
