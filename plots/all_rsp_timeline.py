# -*- coding: utf-8 -*-
"""
CASE Dataset — RSP: nur Individualkurven, Videos hintereinander (seriell)
...
Z_SCORE_PER_SEGMENT = False  # True, wenn pro Segment z-standardisieren
SAVE_FIG = True
FIG_OUT = Path("rsp_individual_serial_by_video.png")
DPI = 200
...
TITLE = "RSP/Respiration — individual curves only; videos in series (0–1 per segment)"
